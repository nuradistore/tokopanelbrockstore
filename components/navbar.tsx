  ...
  return (
    <nav
      className={cn(
        ...
        scrolled ? "glass border-b border-white/10 shadow-[0_18px_50px_-28px_rgba(0,0,0,0.75)]" : "bg-transparent",
      )}
    >
      {scrolled && (
      ...
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        <Link href="/" className="flex items-center space-x-2">
          <ShoppingCart className={cn("w-8 h-8", scrolled ? "text-red-400" : "text-white")} />
          <span className={cn("text-xl font-bold transition-colors text-glow", scrolled ? "text-red-400" : "text-white")}>
            {appConfig.nameHost}
          </span>
        </Link>
      ...
      <motion.div
        ...
        className="md:hidden absolute top-full left-0 right-0 glass shadow-lg border-t border-white/10 overflow-hidden"
      >
