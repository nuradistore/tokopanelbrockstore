        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="https://lynk.id/brockstore" className="text-gray-400 hover:text-red-500 transition-colors">
                  Web Store
                </Link>
              </li>
              <li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="https://whatsapp.com/channel/0029Valq3pQHVvThh0GDrh1w" className="text-gray-400 hover:text-red-500 transition-colors">
                  MarketPlace
                </Link>
              </li>
              <li>
                <Link href="https://youtube.com/@brockstoree" className="text-gray-400 hover:text-red-500 transition-colors">
                  YouTube (BROCK STORE)
                </Link>
              </li>
              <li>
                <Link href="https://youtube.com/@brockstoree?si=DsfdmM50YlVYiFyf" className="text-gray-400 hover:text-red-500 transition-colors">
                  YouTube (BROCK STORE)
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="https://www.instagram.com/brockstoreid" className="text-gray-400 hover:text-red-500 transition-colors">
                  Instagram
                </Link>
              </li>
              <li>
                <Link href="https://www.tiktok.com/@brockstoree" className="text-gray-400 hover:text-red-500 transition-colors">
                  TikTok
                </Link>
              </li>
            </ul>
