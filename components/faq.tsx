...
function FAQItem({
  ...
  return (
    <div
      className={`glass-soft border ${isOpen ? "border-red-500/40" : "border-white/10"} rounded-2xl p-4 transition-all duration-300 card-3d`}
    >
      <button
...
export function FaqSection() {
  ...
  return (
  <section id="faq" className="py-16 relative border-t border-white/10">
